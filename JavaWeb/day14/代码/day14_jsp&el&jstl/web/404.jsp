...
<TABLE cellSpacing=0 cellPadding=0 width=540 align=center border=0>
  ...
  <TR>
    <TD vAlign=top height=270>
      <DIV align=center><BR><IMG height=211 src="/day14/images/error.gif" 
      width=329><BR><BR>
      <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
        <TBODY>
        <TR>
          <TD><FONT class=p2>&nbsp;&nbsp;&nbsp; <FONT color=#ff0000><IMG 
            height=13 src="/day14/images/emessage.gif" 
  ...
  <TR>
    <TD align=middle>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=480 border=0>
        <TBODY>
        <TR>
          <TD width=6><IMG height=26 src="/day14/images/left.gif" 
width=7></TD>
          <TD background=/day14/images/bg.gif>
            <DIV align=center><FONT class=p6><A 
            href="#">返回首页</A>　 　|　　 <A 
            href="javascript:history.go(-1)">返回出错页</A>　 　|　　 <A 
            href="#">关闭本页</A></FONT> </DIV></TD>
          <TD width=7><IMG 
      src="/day14/images/right.gif"></TD></TR></TBODY></TABLE></CENTER></TD></TR></TBODY></TABLE>
<P align=center>　</P>
<P align=center>　</P>
</BODY>
</HTML>